...
const palettes = [
  {
    id: "zorin",
    name: "Zorin",
    color: "linear-gradient(135deg, #0CC1F3, #15A6E0)",
  },
  {
    id: "ubuntu",
    name: "Ubuntu",
    color: "linear-gradient(135deg, #E95420, #DD4814)",
  },
  {
    id: "mint",
    name: "Linux Mint",
    color: "linear-gradient(135deg, #87CF3E, #68B030)",
  },
  {
    id: "manjaro",
    name: "Manjaro",
    color: "linear-gradient(135deg, #35BF5C, #2DA94E)",
  },
  {
    id: "elementary",
    name: "Elementary",
    color: "linear-gradient(135deg, #64BAFF, #3689E6)",
  },
];
  ...
  return (
    <div className="theme-control-wrapper">
      <div className="theme-switch">
        ...
        <button
          className={`theme-switch-btn more-btn ${
            showPalettes ? "active" : ""
          }`}
